    ...
    return(
        <React.Fragment>
            <div className=" bg-slate-100 pb-2 md:py-10 lg:px-14">
                <Heading 
                    className={"lg:text-[26px] md:text-[30px] md:py-4 xs:text-[19px] xs:pt-5 text-center lg:pt-10 font-medium"}
                    ...
                    insodeubiSoftData.map((value)=>{
                        return(
                            <GameCard
                                ...
                                classNameTitle={'relative text-center text-[20px] font-medium w-[415px] h-[120px] bg-[#00000072] pt-4 rounded-b-lg md:text-[25px] leading-6'}
