    ...
    return(
        <React.Fragment>
            <div className="md:py-10 lg:px-14 m-auto">
                <Heading 
                    className={"lg:text-[26px] md:text-[30px] md:py-4 xs:text-[20px] text-center lg:pt-10  xs:mt-5 font-medium"}
                    title={'UBISOFT STORE'}
                />
                        ...
                        ubiSoftStoreData.map((value)=>{
                            return(
                                <GameCard
                                    ...
                                    classNameTitle={'relative mt-5 xs:mt-10 flex justify-center lg:w-[410px] m-auto mx-5 text-center text-[20px] md:text-[15px] font-medium leading-5'}
