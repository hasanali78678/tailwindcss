          ...
          <div className='theme-content'>
            <div className='theme-firstSide '>
              <div className='lg:h-[405px]'>
                ...
                <div>
                  <ul>
                    <li className='theme-categroy-li'>
            ...
            <div className='lg:mx-8 md:hidden xs:hidden'>
              ...
              <div className='md:hidden xs:hidden'>
                <ul>
                  ...
                  <li className='theme-categroy-li'>
                    <a href=''>Avatar: Frontiers of Pandora</a>
                  </li>
                  <li className='theme-categroy-li'>
                    <a href=''>Prince of Persia The Lost Crown</a>
                  </li>
                  <li className='theme-categroy-li'>
                    <a href=''>Assassin's Creed Mirage</a>
                  </li>
                  <li className='theme-categroy-li'>
                    <a href=''>Assassin's Creed Mirage</a>
                  </li>
                  <li className='theme-categroy-li'>
                    <a href=''>Assassin's Creed 4 Black Flag</a>
                  </li>
                  <li className='theme-categroy-li'>
                    <a href=''>Ghost Recon Breakpoint Ultimate Edition</a>
                  </li>
                  <li className='theme-categroy-li'>
                    <a href=''>For Honor</a>
                  </li>
              ...
              <div className='theme-MostPopular'>
                <div className='theme-MostCard'>
                  <MostCard
                    ...
                    CardImage={
                      'https://store.ubisoft.com/dw/image/v2/ABBS_PRD/on/demandware.static/-/Sites-masterCatalog/default/dw4de2b2d7/images/large/6295081027efc536e38350a1.jpg?sw=300&sh=395&sm=fit'
                    }
                  ...
                  <MostCard
                    ...
                    classNamePrice={'theme-Price'}
                    CardImage={
                      'https://store.ubisoft.com/dw/image/v2/ABBS_PRD/on/demandware.static/-/Sites-masterCatalog/default/dwa9e82d35/images/large/61d56f7aa6102b495e0ffff1.jpg?sw=300&sh=395&sm=fit'
                    }
                  ...
                  <MostCard
                    ...
                    classNamePrice={'theme-Price'}
                    CardImage={
                      'https://store.ubisoft.com/dw/image/v2/ABBS_PRD/on/demandware.static/-/Sites-masterCatalog/default/dw35765a7e/images/large/5fb696e80d253c2914972100.jpg?sw=300&sh=395&sm=fit'
                    }
                    GameTitle={'Rocksmith+'}
