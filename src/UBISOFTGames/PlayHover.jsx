        ...
        <div className='theme-con lg:px-12 lg:py-6'>
            ...
            <div className='lg:mx-8 md:hidden xs:hidden'>
              ...
              <div>
                <ul>
                  ...
                  <li className='theme-categroy-li'>
                    <a href=''>The Crew Motorfest</a>
                  </li>
                  <li className='theme-categroy-li'>
                    <a href=''>Star Wars Outlaws</a>
                  </li>
                  <li className='theme-categroy-li'>
                    <a href=''>Just Dance 2024 Edition</a>
                  </li>
                  <li className='theme-categroy-li'>
                    <a href=''>Mario + Rabbids® Sparks of Hope</a>
                  </li>
                  <li className='theme-categroy-li'>
                    <a href=''>Tom Clancy’s The Division Heartland</a>
                  </li>
                  <li className='theme-categroy-li'>
                    <a href=''>Assassin's Creed Nexus VR</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className='lg:ml-5 md:hidden xs:hidden'>
            <div>
              ...
              />
              <div
                className='theme-Discover'
                style={{
                  backgroundImage: `url(https://staticctf.ubisoft.com/J3yJr34U2pZ2Ieem48Dwy9uqj5PNUQTn/4tBpf5HvSRBpQS7geVtpOm/511011752152e6d8b4b0530aeb2e7d62/ubi-global_nav-discover_ubi_plus.jpg)`,
                }}
              ></div>
            </div>
