...
const JoinUbi = () => {
  return (
    <React.Fragment>
      <div
        className='lg:hidden md:hidden xs:bg-cover bg-center bg-no-repeat  xs:h-[365px] xs:w-full  xs:py-20'
        style={{
          backgroundImage: `url(https://useruploads.visualwebsiteoptimizer.com/useruploads/244616/images/e9316cf2c841d9408a6fff8a1ef42c76_umobile.png)`,
        }}
      >
